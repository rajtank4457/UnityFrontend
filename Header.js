    ...
    return (
        ...
        <div className="flex items-center justify-between py-0 px-6">
            <a href="/">
                <Image
                    src={logo}
                    className="w-20 h-50 object-contain py-5 "
                    alt=""
                />
            </a>
            ...
            <div className=" lg:flex space-x-6 text-white ">
                ...
                <a href="/" className="link  hover:text-blue-500 hover:border-spacing-2 transition duration-300 ">Why Discord?</a>
            ...
            <button className="bg-white text-black p-2 rounded-full text-xs md:text-sm px-4 focus:outline-none hover:shadow-2xl hover:text-discord_blurple transition duration-200 ease-in-out whitespace-nowrap font-mediu">Open Unity Talk</button>
