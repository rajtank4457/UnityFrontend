...
export default function Header() {
    ...
    return (
        ...
        <div className="flex items-center justify-between py-0 px-6 pr-[200px]">
            ...
            <button className="bg-white text-black p-2  ml-[50px] rounded-full text-xs md:text-sm px-4 focus:outline-none  hover:bg-[#586671] hover:text-white  hover:shadow-2xl hover:text-discord_blurple transition duration-200 ease-in-out whitespace-nowrap font-mediu">Open Unity Talk</button>
